...
export const IPC_CHANNELS = {
  ...
  TELLER_CURRENCIES_LIST: 'teller-currencies:list',
  TELLER_CURRENCIES_CREATE: 'teller-currencies:create',
  TELLER_CURRENCIES_DEACTIVATE: 'teller-currencies:deactivate',
  TELLER_CURRENCIES_REACTIVATE: 'teller-currencies:reactivate',
  TELLER_CURRENCIES_DELETE: 'teller-currencies:delete',
  TELLER_CURRENCIES_DENOMINATIONS_LIST: 'teller-currencies:denominations.list',
  TELLER_CURRENCIES_DENOMINATIONS_CREATE: 'teller-currencies:denominations.create',
  TELLER_CURRENCIES_DENOMINATIONS_DEACTIVATE: 'teller-currencies:denominations.deactivate',
  TELLER_CURRENCIES_DENOMINATIONS_REACTIVATE: 'teller-currencies:denominations.reactivate',
  TELLER_CURRENCIES_DENOMINATIONS_DELETE: 'teller-currencies:denominations.delete',
